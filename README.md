...
<div>Функция transpose в начале проверяет матрицу. Если матрица пустая, то возвращаем пустой список. Далее проверяем матрицу на прямоуголььность и возвращаем элементы из j-го столбца i-й строки</div>
<h2>tuples</h2>
